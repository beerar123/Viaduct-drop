...
public class ViaductDrop {
	...
	//declaring the public static variable
	 static String sFileName ="C:\\Users\\beerar\\Downloads\\Selenium_Automation\\ViaductDroppinglist.xlsx" ;
...
{    
	...
	try {
	Utility4.setExcelFile("C:\\Users\\beerar\\Downloads\\Selenium_Automation\\ViaductDroppinglist.xlsx", "Sheet1");}
	...
	promptAlert1.accept();
	Thread.sleep(8000);
	Utility4.setExcelFile("C:\\Users\\beerar\\Downloads\\Selenium_Automation\\ViaductDroppinglist.xlsx", str);
	...
	if(count>=1) {
		...
		if(count>=1) {
			...
			Utility4.setExcelFile("\\USHOUHOME01\beerar\\Desktop\\Selenium_Automation\\ViaductDroppinglist.xlsx", "Sheet1");
			Utility4.setCellData("Pass", row, 5);
		}
