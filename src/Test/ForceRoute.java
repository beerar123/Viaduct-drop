...
public class ForceRoute {
	static String sFileName ="C:\\Users\\ammanrr.CORP\\eclipse-workspace\\DeleteCommunicationsV1-Copy.xlsx" ;
	  ...
	  public static void main(String[] args) throws Exception {
		 ...
		 try {
			 driver.get(Utility7.getCellData(sFileName,sSheetName,1, 10));

			 driver.findElement(By.xpath("//*[@id='userid']")).sendKeys(Utility7.getCellData(sFileName,sSheetName,1, 11));
			 
			 driver.findElement(By.xpath("//*[@id='password']")).sendKeys(Utility7.getCellData(sFileName,sSheetName,1, 12));
		...
		int totalNoOfRows = Utility7.rowcount(sSheet1);
		...
		System.out.println(Utility7.getCellData(sFileName,sSheetName,row, 0));
		...
		// this is will print the projects in order
			...
			// String text=element1.getText();
				...
				System.out.println(Utility7.getCellData(sFileName,sSheetName,row, 0));
				if (text.equalsIgnoreCase(Utility7.getCellData(sFileName,sSheetName,row, 0))) {
					...
					String s4 = Utility7.getCellData(sFileName,sSheetName,row, 1);
					String s5 = Utility7.getCellData(sFileName,sSheetName,row, 2);
				...
				// This is navigate to investment center which is mentioned in the excel
					...
					// given in excel sheet to navigate to Active date or historical dates
						if (text2.equalsIgnoreCase(Utility7.getCellData(sFileName,sSheetName,row, 3))) {
				...
				try {
						...
						if(element4!=null) {
							...
							try{// given in excel sheet to navigate to Active date or historical dates
								...
								if (text7.equalsIgnoreCase(Utility7.getCellData(sFileName,sSheetName,row, 4))) {
								...
								if (text7.equalsIgnoreCase(Utility7.getCellData(sFileName,sSheetName,row, 5))) {
						...
						try {
							...
							if(elementdate!=null){
								...
								System.out.println("Effective date is:" + text3);
										...
										// given in excel sheet to navigate to Active date or historical dates
								if (text3.equalsIgnoreCase(Utility7.getCellData(sFileName,sSheetName,row, 5))) {
									element3.click();
									break;
									}

								}
						System.out.println(Utility7.getCellData(sFileName,sSheetName,row, 6));
							
						String str = Utility7.getCellData(sFileName,sSheetName,row, 6);
							
						System.out.println("account sheetname"+str);
							
						int totalNoOfRows1 = Utility7.rowcount(str);
							...
							act1.clear();
							act1.sendKeys(Utility7.getCellData(sFileName,str,Arow, 0));
							} catch (Exception e) {
							...
							e4.clear();
							e4.sendKeys(Utility7.getCellData(sFileName,str,Arow, 1));
							} catch (Exception e) {
							...
							if (select1 != null) {
								...
								for (int s = 0; s < isize; s++) {
									...
									if (sValue.equalsIgnoreCase("Force Route")) {
										...
										System.out.println("act# got Force Routed succesfully "+Utility7.getCellData(sFileName,str,Arow, 0));
				...
				int totalNoOfRows1 = Utility7.rowcount(str);
					...
					for (int k = 0; k < links3.size(); k++) {
						...
						System.out.println("Effective date is:" + text3);
							...
							// given in excel sheet to navigate to Active date or historical dates
						if (text3.equalsIgnoreCase(Utility7.getCellData(sFileName, sSheet1, row, 5))) {
							element3.click();
							break;
							}
